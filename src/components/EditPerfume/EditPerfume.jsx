...
const EditPerfume = () => {
  ...
  const { getOnePerfume, updatePerfume, onePerfume } =
        ...
        >
          ...
          >
            ...
            <input
              ...
              style={{ height: "40px", margin: "2%", width: "300px" }}
              type="text"
            ...
            <input
              ...
              style={{ height: "40px", margin: "2%", width: "300px" }}
              type="text"
              placeholder="Введите url для первой картины"
              name="image1"
            />
            <input
              value={edited.image2}
              ...
              style={{ height: "40px", margin: "2%", width: "300px" }}
              type="text"
              placeholder="Введите url второй картины"
              name="image2"
            />
            <input
              value={edited.male}
              ...
              style={{ height: "40px", margin: "2%", width: "300px" }}
              type="text"
              placeholder="Введите мужской или женский"
              name="male"
            />
            <button
              onClick={checkValues}
