...
function deleteFromCart() {
  ...
  return (
    ...
    >
      ...
      <Link to="/"><button style={{marginTop: '100px', backgroundColor: 'rgb(250, 250, 173)', borderRadius: '10px', height: '50px', width: '100px', color: "black"}} onClick={()=>deleteFromCart()}>GO HOME</button></Link>
    </div>
  );
};
